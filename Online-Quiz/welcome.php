...
<body>
    <nav class="navbar navbar-default title1">
        <div class="container-fluid" style="background-color: #fed049">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    if(isset($s)) {
                        if($s <= 1)
                                    echo "<center><h1 style='color:pink;'> Your Performance is Poor </h1></center>";
                                else if($s == 2)
                                    echo "<center><h1 style='color:pink;'> Your Performance is Bad </h1></center>";
                                else if($s == 3)
                                    echo "<center><h1 style='color:pink;'> Your Performance is Good </h1></center>";
                                else if($s == 4)
                                    echo "<center><h1 style='color:pink;'> Your Performance is Strong </h1></center>";
                                else
                                    echo "<center><h1 style='color:pink;'> Your Performance is Very Strong </h1></center>";
                    }
                ?>
</body>
</html>